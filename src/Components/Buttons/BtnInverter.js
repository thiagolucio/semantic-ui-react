...
const BtnInverter = () => (
    <div>
    <Segment inverted>
      <Button icon inverted> <Icon name='chevron left' size='normal' /> Standard</Button>
    ...
    <Segment inverted>
      <Button icon basic inverted><Icon name='user' size='normal' /> Standard</Button>
